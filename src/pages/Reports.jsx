    ...
    <div className='space-y-5 md:space-y-6 animate-fade-in px-2 xs:px-3 md:px-6 py-2 md:py-4'>
      ...
      <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-3 md:gap-4'>
        <div className='flex items-center gap-2 md:gap-3'>
          ...
          <div>
            <h1 className={`text-xl md:text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Attendance Reports</h1>
            <p className={`text-xs md:text-sm ${isDarkMode ? 'text-dark-400' : 'text-gray-500'}`}>Track your daily class attendance</p>
          </div>
        </div>
